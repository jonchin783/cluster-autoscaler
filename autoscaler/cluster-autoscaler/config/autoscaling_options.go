...
type AutoscalingOptions struct {
	...
	// Cisco Container Platform control plane url address
	CiscoCcpAddress string
	// Cisco Container Platform control plane username
	CiscoCcpUsername string
	// Cisco Container Platform control plane password
	CiscoCcpPassword string
}
