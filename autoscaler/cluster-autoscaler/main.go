...
var (
	...
	ciscoCcpAddress  = flag.String("ccp-address", "", "Cisco Container Platform control plane url address")
	ciscoCcpUsername = flag.String("ccp-username", "", "Cisco Container Platform control plane username")
	ciscoCcpPassword = flag.String("ccp-password", "", "Cisco Container Platform control plane password")
)
...
func createAutoscalingOptions() config.AutoscalingOptions {
	...
	return config.AutoscalingOptions{
		...
		CiscoCcpAddress:                  *ciscoCcpAddress,
		CiscoCcpUsername:                 *ciscoCcpUsername,
		CiscoCcpPassword:                 *ciscoCcpPassword,
	}
}
